...
image1 = Image.open("C:/Users/jainl/OneDrive/Desktop/Whatsapp_Chat_Analyzer-main/download.png")

st.sidebar.image(image1,width = 80)
st.sidebar.title("Whatsapp Chat Analyzer")


uploaded_file = st.sidebar.file_uploader("Choose a file ", key="uploader1")
